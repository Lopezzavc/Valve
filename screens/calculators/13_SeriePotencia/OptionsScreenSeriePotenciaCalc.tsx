...
const OPTIONS_DATA: Record<string, string[]> = {
  ...
  dynamicViscosity: ['Pa·s', 'mPa·s', 'cP', 'μPa·s'],
  flow:             ['m³/s', 'L/s', 'm³/min', 'm³/h', 'ft³/s'],
};

const TITLE_I18N_KEY: Record<string, string> = {
  length:           'optionsScreen.titles.length',
  density:          'optionsScreen.titles.density',
  dynamicViscosity: 'optionsScreen.titles.dynamicViscosity',
...
const OptionsScreenSeriePotenciaCalc = () => {
  const navigation =
    useNavigation<StackNavigationProp<RootStackParamList>>();
  const route = useRoute<
    RouteProp<RootStackParamList, 'OptionsScreenSeriePotenciaCalc'>
  >();
...
export default OptionsScreenSeriePotenciaCalc;