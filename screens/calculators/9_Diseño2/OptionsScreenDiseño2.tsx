...
const TITLE_I18N_KEY: Record<string, string> = {
  length: 'diseñoCalc2.labels.L',
  viscosity: 'diseñoCalc2.labels.mu',
  flow: 'diseñoCalc2.labels.Qd',
  acceleration: 'diseñoCalc2.labels.g',
};
...
const OptionsScreenDiseño2 = () => {
  const navigation = useNavigation<StackNavigationProp<RootStackParamList>>();
  const route = useRoute<RouteProp<RootStackParamList, 'OptionsScreenDiseño2'>>();
...
export default OptionsScreenDiseño2;